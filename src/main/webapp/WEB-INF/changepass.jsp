...
<body>
	<div class="container">
		...
		<div class="content">
			<form action="/set-pass" method="post">
				<div class="user-details">
					...
					<div class="input-box">
						<span class="details">Old Password</span> <input type="password"
							placeholder="Old Password" name="password1" required="required">
					</div>
					<div class="input-box">
						<span class="details">New Password</span> <input type="password"
							placeholder="New Password" name="password2" required="required">
					</div>
				</div>
				<div class="button">
